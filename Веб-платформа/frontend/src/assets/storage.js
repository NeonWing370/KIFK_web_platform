(function () {
  const STORAGE_KEY = "KIFK-platform";
  const LEGACY_KEY = "KIFKJsonData";
  const DATA_FILE = "data/KIFK-platform.json";

  const presetUsers = [
    {
      id: 1,
      name: "Platform Admin",
      email: "admin@KIFK.local",
      password: "admin123",
      role: "admin",
  ...
  function downloadJson(data) {
    ...
    link.href = url;
    link.download = "KIFK-platform.json";
    link.click();
